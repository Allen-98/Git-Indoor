...
namespace AmazingAssets.AdvancedDissolveEditor
{
    class SpeedTree8ShaderGUI : ShaderGUI
    {
        ...
        public override void OnGUI(UnityEditor.MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            AmazingAssets.AdvancedDissolveEditor.MaterialEditor.DrawCurvedWorldHeader(materialEditor, (Material)materialEditor.target);


            if (AmazingAssets.AdvancedDissolveEditor.MaterialEditor.DrawDefaultOptionsHeader("Speed Tree", null, null))
            {
